<template>
    <div> <span style="font-size: 18px;">设备管理</span> <el-button style="float: right;" type="danger"
            round @click="dialogFormVisible = true">添加设备</el-button>
        ...
        <el-table :data="documentList" border max-height="480px" v-loading="tableLoading"
            ...
            <el-table-column fixed="right" label="操作">
                <template>
                    <el-button type="text" @click="confirmDelete">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
